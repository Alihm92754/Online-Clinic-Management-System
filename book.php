...
<body style="background-image:url(userbackground1.jpg)">
	<div class="header">
		<ul>
			<li style="float:left;border-right:none"><a href="ulogin.php" class="logo"><strong> &#127978; Wecare Medical Clinic &#127978; </strong>Appointment Booking System</a></li>
			<li><a href="book.php">Book Now</a></li>
			<li><a href="ulogin.php">Home</a></li>
		</ul>
	</div>
	<form action="book.php" method="post">
	<div class="sucontainer" style="background-image:url(userbackground.jpg)">
