...
<body style="background-image:url(fullbackground.jpg)">
<div class="header">
				<ul>
...
<center><h2>Your Appoinments</h2><hr>
	<?php
	$cid=$_SESSION['cid'];
    $username=$_SESSION['username'];
		$sql1 = "Select * from book where did ='".$cid."' order by DOV desc";

			$result1=mysqli_query($conn, $sql1);  
			echo "<table style=margin-top:2% align=center>
					<tr>
