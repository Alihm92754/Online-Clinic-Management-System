...
<link rel="stylesheet" href="main.css">
			...
			<br>
				...
				<p style="text-align:center;color:black;font-size:30px;top:35%"><u>Online Appointment Booking System</u></p><br>
				<button onclick="document.getElementById('id01').style.display='block'" style=" background-color: green; position:absolute;top:50%;left:35%">Login</button>
				<form action="signup.php">
                <button class="button" style="background-color: green; position:absolute;top:50%;left:60%" >Sign Up</button>
                </form>
