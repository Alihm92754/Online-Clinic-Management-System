...
<div class="container" style="width:100%">
	<div class="container" style="background-image:url(userbackground.jpg)">
	
	<form method="post" style="background-image:url(userbackground.jpg)">
	  <button type="button" name="change" onclick="window.location.href='changebookingstatus.php'" style="background-color:#2B4F76">Change/View Booking Status</button>
