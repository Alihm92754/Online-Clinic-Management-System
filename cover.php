...
<body style="background-image:url(mainbackground.png)">
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><strong> &#127978; Wecare Medical Clinic &#127978; </strong>Appointment Booking System</a></li>
			...
			<div class="center">
				...
				<p style="text-align:center;color:black;font-size:30px;top:35%"><u>Online Appointment Booking System</u></p>
				<img src="1.jpg" alt="1" style="width:38%;">
				<button onclick="document.getElementById('id01').style.display='block'" style=" background-color: green; position:absolute;top:75%;left:35%">Login</button>
				<form action="signup.php">
                <button class="button" style="background-color: green; position:absolute;top:75%;left:60%" >Sign Up</button>
                </form>
			...
			<div class="footer">
				<ul style="position:absolute;top:93%;background-color:black">
					...
					<li><a href="admin/doctor-login.php">doctor Login</a></li>
				</ul>
			</div>
